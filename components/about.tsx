        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl sm:text-4xl font-bold text-foreground leading-tight">
             ...
             <div className="mt-6 space-y-6 text-muted-foreground leading-8 text-[17px]">
              <p>
              ...
              a abrigar pessoas em situação de vulnerabilidade. 
              A iniciativa, promovida por maçons e espíritas, recebeu o nome de 
              Liga Filantrópica, oferecendo abrigo aos mais necessitados.
              </p>
              <p>
              ...
              A união entre espíritas, maçons e católicos marcou uma nova fase da entidade, 
              que passou a se estruturar oficialmente como Liga Filantrópica Santarritense, 
